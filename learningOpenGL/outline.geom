...
void main(){
	...
	vec4 pos1 = data_in[0].cameraMatrix * (data_in[0].given_translation_matrix * data_in[0].posMatrix * gl_in[0].gl_Position + normal* 0.001);


	gl_Position = pos1;
	EmitVertex();
	gl_Position = data_in[0].cameraMatrix * (data_in[0].given_translation_matrix * data_in[0].posMatrix * gl_in[1].gl_Position + normal* 0.001);
	EmitVertex();
	gl_Position = data_in[0].cameraMatrix * (data_in[0].given_translation_matrix * data_in[0].posMatrix * gl_in[2].gl_Position + normal* 0.001);
	EmitVertex();
	gl_Position = data_in[0].cameraMatrix * (data_in[0].given_translation_matrix * data_in[0].posMatrix * gl_in[0].gl_Position + normal * 0.001);
	EmitVertex();
	EndPrimitive();
}
